...
def worker(rank_gpu, args):
    ...
    while True:
        ...
        step1_loss_epoch, step2_loss_epoch, cls_s_loss_epoch, sim_loss_epoch, domain_s_loss_epoch, \
        ...
        sim_loss_epoch /= iteration * CFG.DATALOADER.BATCH_SIZE
        ...
        logging.info(
            'rank{} train epoch={} | loss_s1={:.3f} loss_s2={:.3f} loss_cls_s={:.3f} loss_sim={:.3f} '
            'loss_domain_s={:.3f} loss_domain_t={:.3f} loss_difference_s={:.3f} loss_difference_t={:.3f}'
            .format(dist.get_rank() + 1, epoch, step1_loss_epoch, step2_loss_epoch, cls_s_loss_epoch, sim_loss_epoch,
