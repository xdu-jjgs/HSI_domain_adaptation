...
def worker(rank_gpu, args):
    ...
    while True:
        ...
        total_loss_epoch, cls_loss_epoch, sim_loss_epoch, difference_s_loss_epoch, \
            difference_t_loss_epoch, recon_s_loss_epoch, recon_t_loss_epoch = 0., 0., 0., 0., 0., 0., 0.
        for iteration in train_bar:
            ...
            total_loss = cls_loss + sim_loss + difference_s_loss + difference_t_loss + recon_s_loss + recon_t_loss
        ...
        logging.info(
            'rank{} train epoch={} | loss_total={:.3f} loss_cls={:.3f} loss_sim={:.3f} loss_difference_s={:.3f} '
            'loss_difference_t={:.3f} loss_recon_s={:.3f}loss_recon_t={:.3f}'.format(
                dist.get_rank() + 1, epoch, total_loss_epoch, cls_loss_epoch, sim_loss_epoch,
