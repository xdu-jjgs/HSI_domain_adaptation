...
python train/dsn/train_nodecoder_noamp_infonce.py configs/hyrank/dsn/dsn_inn_nodecoder_revnet38_infonce.yaml ^
        --path ./runs/hyrank/dsn_inn_nodecoder_revnet38_infonce-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
