...
def worker(rank_gpu, args):
    ...
    while True:
        ...
        for iteration in train_bar:
            ...
            optimizer.zero_grad()
            shared_f_s, private_f_s, y_s, domain_out_s, decoder_out_s = model(x_s, 1, True, True)
            shared_f_t, private_f_t, y_t, domain_out_t, decoder_out_t = model(x_t, 2, True, True)
        ...
        for x_t, label in val_bar:
            ...
            _, _, y_t, _, _ = model(x_t, 2, True, True)
