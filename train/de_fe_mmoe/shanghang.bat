...
python train/de_fe_mmoe/de_fe_mmoe_dadst_var.py configs/shanghang/de_fe_mmoe/de_fe_resnet_mmoe_dadst_shared_var.yaml ^
        --path ./runs/shanghang/de_fe_resnet_mmoe_dadst_shared_var-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
