...
python train/de_fe_mmoe/de_fe_mmoe_dadst_var.py configs/hyrank/de_fe_mmoe/de_fe_resnet_mmoe_dadst_var.yaml ^
        --path ./runs/hyrank/de_fe_resnet_mmoe_dadst_var-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
...
rem de_fe_mmoe_dadst
python train/de_fe_mmoe/de_fe_mmoe_dadst_var.py configs/hyrank/de_fe_mmoe/de_fe_resnet_mmoe_dadst_gate_conv_var.yaml ^
        --path ./runs/hyrank/de_fe_resnet_mmoe_dadst_gate_conv_var-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
