...
rem mmoe-sol1
python train/fe_mmoe/train_sol1.py configs/houston/fe_mmoe/fe_mmoe_fe2_sol1.yaml ^
        --path ./runs/houston/fe_mmoe/fe_mmoe_fe2_sol1-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
...
rem mmoe-sol1
python train/fe_mmoe/train_sol1.py configs/houston/fe_mmoe/fe_mmoe_att2_sol1.yaml ^
        --path ./runs/houston/fe_mmoe/fe_mmoe_att2_sol1-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
