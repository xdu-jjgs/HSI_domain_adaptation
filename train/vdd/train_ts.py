...
def worker(rank_gpu, args):
    ...
    while True:
        ...
        cls_loss_epoch, domain_s_loss_epoch, domain_t_loss_epoch, decomposed_s_loss_epoch, \
            decomposed_t_loss_epoch = 0., 0., 0., 0., 0.
        step1_loss_epoch, step2_loss_epoch = 0., 0.
        for iteration in train_bar:
            ...
            # step1: The step of feature decomposition
            ...
            step2_loss = cls_loss + domain_s_loss + domain_t_loss + decomposed_s_loss + decomposed_t_loss
        ...
        logging.info(
            'rank{} train epoch={} | loss_s1={:.3f} loss_s2={:.3f} loss_cls={:.3f} loss_domain_s={:.3f} '
            'loss_domain_t={:.3f} loss_decomposed_s={:.3f} loss_decomposed_t={:.3f}'.format(
                dist.get_rank() + 1, epoch, step1_loss_epoch, step2_loss_epoch, cls_loss_epoch, domain_s_loss_epoch,
                domain_t_loss_epoch, decomposed_s_loss_epoch, decomposed_t_loss_epoch
            ))
        logging.info(
